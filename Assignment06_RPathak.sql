...
-- 03/06/2025, RPathak,Created File
--**************************************************************************--
Begin Try
	Use Master;
	If Exists(Select Name From SysDatabases Where Name = 'Assignment06DB_RPathak')
	 Begin 
	  Alter Database [Assignment06DB_RPathak] set Single_user With Rollback Immediate;
	  Drop Database Assignment06DB_RPathak;
	 End
	Create Database Assignment06DB_RPathak;
End Try
Begin Catch
	Print Error_Number();
End Catch
go
Use Assignment06DB_RPathak;
...
WITH SCHEMABINDING  -- binds tables schema to the view such that any modifications to the table that will break this view will not be allowed on teh table
As
...
WITH SCHEMABINDING
As
Select InventoryID, EmployeeID, ProductID, Count From [dbo].[Inventories]
Go
...
As
	Select Top 100 Percent
    Manager.EmployeeFirstName + ' ' + Manager.EmployeeLastName AS ManagerName,
...
As
	...
	i.InventoryDate, i.Count, e.EmployeeID, e.EmployeeFirstName + ' ' +e.EmployeeLastName as Employee, 
